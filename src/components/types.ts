...
/**
 * Style props shared by both <Box> and <Text> components.
...
/**
 * Props for the `<Box>` component (a container node).
 *
...
/**
 * Props for the `<Text>` component (a leaf text node).
 *
...
/**
 * Props for the `<RawAnsi>` component. Bypasses text wrapping and
